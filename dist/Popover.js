...
import { Platform, Dimensions, Animated, TouchableWithoutFeedback, View, Modal, Keyboard, Easing, StyleSheet, I18nManager, ViewPropTypes } from 'react-native';
...
var AdaptivePopover = /** @class */ (function (_super) {
    ...
    AdaptivePopover.prototype.render = function () {
        ...
        return (React.createElement(BasePopover, __assign({}, otherProps, { displayArea: this.getDisplayArea(), fromRect: fromRect, onOpenStart: function () {
                ...
                _this.keyboardDidShowListener = Keyboard.addListener('keyboardDidShow', _this.keyboardDidShow.bind(_this));
                _this.keyboardDidHideListener = Keyboard.addListener('keyboardDidHide', _this.keyboardDidHide.bind(_this));
                _this.displayAreaStore = _this.getDisplayArea();
            }, onCloseStart: function () {
                onCloseStart && onCloseStart();
                _this.debug("Tearing down keyboard listeners");
                _this.keyboardDidShowListener && Keyboard.removeListener("keyboardDidShow");
                _this.keyboardDidHideListener && Keyboard.removeListener("keyboardDidHide");
...
var BasePopover = /** @class */ (function (_super) {
    ...
    BasePopover.prototype.handleChange = function () {
        ...
        this.handleChangeTimeout = setTimeout(function () {
            ...
            var _b = _this.props, arrowStyle = _b.arrowStyle, popoverStyle = _b.popoverStyle, fromRect = _b.fromRect, displayArea = _b.displayArea, placement = _b.placement, onOpenStart = _b.onOpenStart;
